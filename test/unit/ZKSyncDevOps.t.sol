...
/**
 * ZkSyncChainChecker → Checks which CHAIN / VM you’re on
 * It gives modifiers like:
 *  -skipZkSync
 *  -onlyZkSync
 * This answers:
 *      “Am I running on zkSync chain or normal EVM chain?
 */
import {ZkSyncChainChecker} from "lib/foundry-devops/src/ZkSyncChainChecker.sol";

/**FoundryZkSyncChecker → Checks which FOUNDRY VERSION you’re using
 * It gives modifiers like:
 *  -onlyVanillaFoundry
 *  -onlyFoundryZkSync
 *  This answers:
 *      “Am I running foundryup or foundryup-zksync?
 */
